...
export const scene04 = {
  ...
  renderUnderlay() {
    ...
    return sceneMarkup(`<section class="scene scene04 absolute inset-0 overflow-hidden font-sans text-bema-navy"><div class="scene-live-chip"><span></span>LIVE</div><div class="particle-layer particle-field">${particles}</div><div class="light-streak"></div><div class="scene04-brand-row scene-brand-lockup"><img class="scene04-brand-mark" src="${ASSET_PATHS.logos.mark}" alt="BemaHub mark"><img class="scene04-brand-wordmark" src="${ASSET_PATHS.logos.wordmark}" alt="BemaHub"></div><div class="stinger-copy wave-layer"><div class="scene04-statements"><p data-control-cue="statement-1"><i>◉</i><span>Every <strong class="blue">creator</strong> deserves <strong class="blue">to be seen</strong>.</span></p><p data-control-cue="statement-2"><i>♧</i><span>Every <strong class="cyan">Builder</strong> deserves a meaningful way to <strong class="blue">help creative value move</strong>.</span></p><p data-control-cue="statement-3"><i>♙</i><span>Every <strong class="blue">community</strong> deserves a chance to <strong class="red">grow together</strong>.</span></p></div><span class="scene04-rule"></span><p class="scene04-welcome">Welcome to <strong>Bema.</strong> Welcome to <strong class="blue">Open Enrollment 2026.</strong></p></div></section>`)
  },
